...
def test_uses_each_leaf_key_metric(tree_factory) -> None:
...
def test_empty_tree_is_vacuously_one(tree_factory) -> None:
    root = tree_factory({}, {})
    assert OverallLeafScore().compute(root) == 1.0
